         ...
         <div className="grid md:grid-cols-2 gap-8">
           <div className="bg-gradient-to-br from-[#A5375C]/10 to-[#C84862]/10 rounded-xl p-8 border border-[#A5375C]/20">
             ...
             <p className="text-[#6B7280] mb-4">
               ...
               mental health challenges, trauma, and life transitions. Every
               hour you give, every dollar you raise, and every connection you
               make helps create positive change.
             </p>
           ...
           <div className="bg-gradient-to-br from-[#3C6A72]/10 to-[#4A7A82]/10 rounded-xl p-8 border border-[#3C6A72]/20">
             ...
             <p className="text-[#6B7280] mb-4">
               Become part of a supportive network of like-minded individuals
               who are passionate about women&apos;s mental health and community
